                ...
                <div class="container-fluid px-4">
                    <section class="Book Report">
                        ...
                        <form class="p-6 col-md-4" action="include/mostorderbook.inc.php" method="post">
                            ...
                            <button type="submit" name="submitcat" class="btn btn-primary">Submit</button>
                        </form>
                        ...
                        <div>
                            ...
                            if (!empty($result)) {
                                ...
                                echo '<p>The top category is <strong>' . $result[0]['category_name'] . '</strong>, and has been ordered <strong>' . $result[0]['total_quantity'] . '</strong> times.</p>';

                                // If you have more than one result, loop through the array to display each one
                                if ($result) {
                                    echo '<table class="table table-striped">';
                                    echo '<thead><tr><th>Category ID</th><th>Category Name</th><th>Total Quantity</th></tr></thead>';
                                    echo '<tbody>';
