            ...
            <main>
                <div class="container-fluid px-4">
                    <section class="Book Report">
                        <h3 class="p-5"> Top Selling Books</h3>
                        ...
                        <div>
                            ...
                            if (!empty($result)) {
                                ...
                                echo '<p>The book with the most orders has an Book title of <strong>' . $result[0]['title'] . '</strong>, and has been ordered <strong>' . $result[0]['total_quantity'] . '</strong> times.</p>';
