            ...
            <main>
                <div class="container-fluid px-4">
                    <section class="Book Register">
                        <h3 class="p-5">Insert New Author</h3>
                        <form class="p-5 col-md-6" action="include/insertauthor.inc.php" method="post">
                            <div class="form-group">
                                <label for="AuthorName">Author Name</label>
                                <input type="text" name="author_name" class="form-control p-3 mb-3" placeholder="Author Name">
                            </div>
