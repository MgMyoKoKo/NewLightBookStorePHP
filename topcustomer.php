                ...
                <div class="container-fluid px-4">
                    <section class="Book Report">
                        ...
                        <form class="p-6 col-md-4" action="include/mostorderbook.inc.php" method="post">
                            ...
                            <button type="submit" name="submittop" class="btn btn-primary">Submit</button>
                        </form>
                        ...
                        <div>
                            ...
                            if (!empty($result)) {
                                ...
                                echo '<p>The top customer name is <strong>' . $result[0]['first_name'] . $result[0]['last_name'] . '</strong>, and has been ordered <strong>' . $result[0]['total_quantity'] . '</strong> times.</p>';

                                // If you have more than one result, loop through the array to display each one
                                if ($result) {
                                    echo '<table class="table table-striped">';
                                    echo '<thead><tr><th>Customer ID</th><th>First Name</th><th>Last Name</th><th>E-Mail Address</th><th>Total Quantity</th></tr></thead>';
                                    echo '<tbody>';
