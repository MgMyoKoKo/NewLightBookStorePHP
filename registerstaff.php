            ...
            <main>
                <div class="container-fluid px-4">
                    <section class="Staff Register">
                        ...
                        <form enctype="multipart/form-data" class="p-5 col-md-6" action="include/.inc.php" method="post">
                            <div class="form-group">
                                <label for="bookTitle">Staff First Name</label>
                                <input type="text" name="first_name" class="form-control" placeholder="Book Title">
                            </div>
                            <div class="form-group">
                                <label for="isbn">Staff Last Name</label>
                                <input type="text" name="last_name" class="form-control" placeholder="ISBN">
                            </div>
                            <div class="form-group">
                                <label for="numPages">Password</label>
                                <input type="password" name="password" class="form-control" placeholder="Number Of Pages">
                            </div>
                            <div class="form-group">
                                <label for="pubDate">Confirm Password</label>
                            ...
                            <div class="form-group">
                                <label for="bookImage">Staff Address</label>
